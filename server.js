  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family:Arial,sans-serif; color:#333; max-width:600px; margin:auto; border:1px solid #e0e0e0; border-radius:10px; padding:20px; background:#fafafa;">
        ...
        <div style="text-align:center; margin-bottom:20px;">
          <a href="#" onclick="navigator.clipboard.writeText('${code}')" style="padding:10px 20px; font-size:16px; border:none; border-radius:5px; background:#007bff; color:#fff; text-decoration:none;">Copy Code</a>
        </div>
